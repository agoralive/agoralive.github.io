...
contract MATICMIXER {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(7, 18));
        plans.push(Plan(14, 16));
        plans.push(Plan(21, 14));
		plans.push(Plan(7, 18));
        plans.push(Plan(14, 16));
    ...
    uint256 constant private PROJECT_FEE = 600;
	uint256 constant private DEVELOPER_FEE = 200;
